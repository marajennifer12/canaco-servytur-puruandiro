...
<body>
  ...
  <!-- Page Header Start -->
<div class="container-fluid bg-page-header" style="margin-bottom: 90px; background-image: url('img/Nosotros.jpg'); background-size: cover; background-position: center; position: relative;">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px;">
            <h3 class="display-3 text-white text-uppercase">Conoce más acerca de nosotros</h3>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    <h2 class="position-relative text-center bg-white text-primary rounded p-3 mt-4 mb-4 d-none d-lg-block" style="width: 350px; margin-left: -205px;">97 años vigentes</h2>
                    <h6 class="text-uppercase">Conócenos</h6>
                    <h1 class="mb-4">Misión</h1>
                    <p>Aquí va la misión de la CANACO SERVYTUR PURUÁNDIRO</p>
                    <br><h1 class="mb-4">Visión</h1>
                    <p>Aquí va la visión de la CANACO SERVYTUR PURUÁNDIRO</p>
                </div>
            </div>
        </div>
    </div>
